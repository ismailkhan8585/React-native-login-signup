  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.textConatiner}>
        <Text style={styles.haedingText}>Lets get,</Text>
        <Text style={styles.haedingText}>started</Text>
      </View>
      {/* Form start */}
      ...
      <View style={styles.formcontainer}>
        <View style={styles.inputContainer}>
          <SimpleLineIcons name={'screen-smartphone'} size={30} color={colors.Secodnary} />
          <TextInput
            style={styles.textInput}
